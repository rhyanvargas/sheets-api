...
//Given an OAuth2 access token, Create the credentials and initializes the Sheets API client.
...
// Define a simple Spreadsheet object and call the spreadsheets.create method to create it on the server.
...
// Loop over each column and create a CellData object for each one
...
// Transform the records to cells and make the API requests
...
// Convert the Order objects into cells
...
// Create requests for building the pivot table
